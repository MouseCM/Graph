...
def database():
    ...
    img1 =Image.open('image/welcome_bg.jpg')
    bg1 = ImageTk.PhotoImage(img1)
    
    img2 = Image.open('image/home_bg.jpeg')
    bg2 = ImageTk.PhotoImage(img2)

    img3 = Image.open('image/about_bg.jpg')
...
def create_home():
    ...
    canvas_h.create_text( 373, 230, text = 'Enter start row', font = ('Helvetica bold', 14))
    e2 = Entry(f_home)
